...
function activate(context) {
    let disposable = vscode.commands.registerCommand('extension.print', function () {
        ...
        let tempFile = path.join(tempDir, title + ".html")
...
function buildHtml(text, language) {
    ...
    let css = "https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/codemirror.css";
    let js = "https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/codemirror.min.js";
    let lang = "https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/mode/" + mode + "/" + mode + ".js";

    // for htmlmixed
    let xml = "https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.31.0/mode/xml/xml.js";
...
// https://github.com/silverwind/CodeMirror/blob/master/mode/meta.js
var modeInfo = [
